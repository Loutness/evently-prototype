# Evently - Prototype de Gestion d'Événements
...
*   **La vision produit** : Créer une expérience utilisateur fluide pour la découverte d'événements locaux.
*   **L'architecture technique** : Mise en place d'une stack moderne et scalable (React, TypeScript, Vite).
...
*   **Gestion** : Possibilité pour les organisateurs de publier de nouveaux événements.
